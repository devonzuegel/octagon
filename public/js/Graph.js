...
// if (toString(typeof(cash_data)) != undefined) {
  ...
  var grossBurnGraph = generateGraph('#grossBurnGraph', { 
    xs: { 
      'Forecasted Gross burn': 'x1', 
      'Gross burn': 'x2' 
    },
    columns: [
  ...
  var netBurnGraph = generateGraph('#netBurnGraph', { 
  ...
  var revenueGraph = generateGraph('#revenueGraph', { 
    xs: { 'Revenue': 'x1' },
    columns: [
  ...
  var headCountGraph = generateGraph('#headCountGraph', { 
    xs: { 'Head count': 'x1' },
    columns: [
  ...
  var avgDauGraph = generateGraph('#avgDauGraph', { 
    xs: { 'AVG DAU': 'x1' },
    columns: [
  ...
  var avgMauGraph = generateGraph('#avgMauGraph', { 
    xs: { 'AVG MAU': 'x1' },
    columns: [
  ...
  var churnGraph = generateGraph('#churnGraph', { 
    xs: { 'Churn': 'x1' },
    columns: [
  ...
  var ltvGraph = generateGraph('#ltvGraph', { 
    xs: { 'LTV': 'x1' },
    columns: [
  ...
  var lifetimeEstGraph = generateGraph('#lifetimeEstGraph', { 
    xs: { 'Lifetime est.': 'x1' },
    columns: [
  ...
  var cacGraph = generateGraph('#cacGraph', { 
    xs: { 'CAC': 'x1' },
    columns: [
  ...
  var aspGraph = generateGraph('#aspGraph', { 
    xs: { 'ASP': 'x1' },
    columns: [
  ...
  var gmPercentageGraph = generateGraph('#gmPercentageGraph', { 
    xs: { 'GM %': 'x1' },
    columns: [
